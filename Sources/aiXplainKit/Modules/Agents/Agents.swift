...
public final class Agent: Codable {
    ...
    public init(id: String, name: String, status: String, teamId: Int, description: String, llmId: String, createdAt: Date, updatedAt: Date) {
        self.id = id
        self.name = name
        self.status = status
        self.teamId = teamId
    ...
    private enum CodingKeys: String, CodingKey {
        case id, name, status, teamId, description, llmId, createdAt, updatedAt
    }
}
...
extension Agent {
    ...
    public func run(_ agentInput: any AgentInputable, sessionID: String? = nil, parameters: AgentRunParameters = .defaultParameters) async throws -> AgentOutput {
        ...
        guard let url = URL(string: backendURL.absoluteString + "/sdk/agents/" + self.id + "/run") else {
